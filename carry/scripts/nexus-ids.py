...
The mod page URL carries 3560, which is not the id the v3 API wants for either
...
GAME = "crimsondesert"
# The number in the mod page URL. 3560 is the Bounty Teleportation page, created
# 20 September 2026. Do not borrow another mod's, which is how a Glint
# Spotter announcement reached the Flight Freedom page on 14 September 2026.
PAGE_ID = os.environ.get("NEXUS_PAGE_ID", "").strip() or "3560"
